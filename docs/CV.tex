...
\begin{itemize}
  \item Developed statistical models based on effective field theories.
  ...
  \item Introduced a novel definition for eigenvalues in the context of nonlinear problems.
\end{itemize}
}
...
\item Contributed machine-learning modules to the EU interTwin Digital Twin Engine, integrating normalizing flows for lattice QCD simulations.
