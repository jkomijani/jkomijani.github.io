...
\begin{itemize}[leftmargin=*]
    ...
    \item Contributions to precision determinations of parameters of the Standard Model of Particle Physics.
...
\cventry{Mentoring}{Co-supervised PhD, MSc, and BSc researchers in physics \& scientific ML:}{}{}{}{
    ...
    \item Gauge-equivariant U-Net for diffusion models in lattice gauge theory (MSc project).
    \item Autoregressive generative models for lattice configurations (MSc project).
    \item Continuous-time generative models and normalizing flows (MSc projects).
    \item Rational-quadratic splines for normalizing flows (MSc projects).
